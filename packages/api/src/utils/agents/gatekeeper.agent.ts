...
export const analyzeCropImage = async (imageBase64: string) => {
                ...
                responseSchema: {
                    ...
                    properties: {
                        ...
                        isValidCrop: {
                            ...
                            description: "True ONLY if the image contains a plant, crop, fruit, or vegetable. False for selfies, documents, or non-agri objects.",
                        },
                        confidence: {
                        ...
                        rejectionReason: {
                            ...
                            description: "If invalid, explain why (e.g., 'Blurred', 'Not a plant'). If valid, return 'None'.",
                        },

                        // --- Metadata / Labeling Logic ---
                        cropDetected: {
                            type: SchemaType.STRING,
                            description: "The specific crop name (e.g., 'Sugarcane', 'Tomato'). Use 'Unknown' if unclear.",
                        },
                        visualIssue: {
                            type: SchemaType.STRING,
                            description: "Short visual observation (e.g., 'Yellowing leaves', 'Rust spots', 'Healthy'). NOT a medical diagnosis.",
                        },

                        // Note: We ask for a SLUG, not a full filename.
                        filenameSlug: {
                            type: SchemaType.STRING,
                            description: "A short, snake_case descriptor of the content. Example: 'sugarcane_rust' or 'tomato_early_blight'. DO NOT include numbers or IDs.",
                        },
                        description: {
                            type: SchemaType.STRING,
                            description: "A professional 1-sentence summary of the visual data for the Admin Dashboard.",
                        },
                    },
                    required: ["isValidCrop", "confidence", "cropDetected", "visualIssue", "filenameSlug", "description"],
                },
            },
        });
    ...
    `;
        ...
        return {
            ...
            rejectionReason: analysis.rejectionReason === "None" ? null : analysis.rejectionReason,
            metadata: {
