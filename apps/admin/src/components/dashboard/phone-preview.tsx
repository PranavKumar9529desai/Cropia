...
export function PhonePreview({ control }: PhonePreviewProps) {
    ...
    return (
        <div className="mx-auto w-[300px] h-[600px] bg-gray-900 rounded-[3rem] p-4 shadow-2xl border-[8px] border-gray-800 relative ring-1 ring-gray-950/50 select-none overflow-hidden">
            ...
            {/* Screen Content */}
            <div className="w-full h-full bg-cover bg-center rounded-[2.2rem] overflow-hidden relative"
                style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1516655855035-d5215bcb5604?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80")', backgroundBlendMode: 'overlay', backgroundColor: 'rgba(0,0,0,0.3)' }}>
                ...
                <div className="text-center mt-12 text-white drop-shadow-md z-10 relative">
                    <div className="text-5xl font-light tracking-tighter">{currentTime}</div>
                    <div className="text-sm font-medium opacity-90 mt-1">Wednesday, October 25</div>
                </div>
                        ...
                        <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-3 shadow-lg border border-white/40 transform transition-all duration-300 hover:scale-[1.02]">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[10px] font-semibold text-gray-700 uppercase tracking-wide">Cropia</span>
                                </div>
                            ...
                            <div className="flex gap-3">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-600 leading-relaxed line-clamp-3">
                                        {values.body || "Notification message details will appear here..."}
                                    </p>
                                </div>
                                {values.imageUrl && (
