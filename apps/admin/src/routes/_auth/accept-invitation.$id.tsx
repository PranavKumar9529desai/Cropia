...
function AcceptInvitePage() {
    ...
    const handleSignUp = async (values: SignUpFormValues) => {
        const toastId = toast.loading("Creating Account and Joining Organization...")
        try {
            ...
            if (acceptError) {
                ...
                toast.success("Account created! Please verify your email to continue.", { id: toastId })
                navigate({
                    to: '/check-email',
            ...
            toast.success("Welcome! You have joined the organization.", { id: toastId })
            navigate({
                to: '/check-email',
                search: { email: values.email }
            })
