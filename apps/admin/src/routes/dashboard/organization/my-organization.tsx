...
function RouteComponent() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col overflow-hidden container mx-auto">
      ...
      {/* STICKY HEADER AREA */}
      <div className="p-4 md:p-6 px-4 md:px-8 py-4 md:py-6 border-b border-border/50 sticky top-0 z-20 bg-background/95 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2 md:gap-3 w-full md:w-auto">
            <Link to="/dashboard/settings" className="flex-1 md:flex-none">
              <Button
                variant="outline"
                size="sm"
                className="w-full h-9 px-3 gap-2 rounded-xl text-[10px] md:text-xs font-bold"
              >
            ...
            >
              <Button
                size="sm"
                className="w-full h-9 px-3 gap-2 rounded-xl text-[10px] md:text-xs font-bold bg-primary hover:bg-primary/90"
              >
        ...
        <div className="container max-w-7xl mx-auto p-4 md:p-8 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-16">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
            {statItems.map((stat) => (
              <Card
                key={stat.label}
                className="space-y-2 md:space-y-3 p-3 md:p-4"
              >
                  ...
                  <PieChart>
                    ...
                    <Pie
                      data={(charts?.health || []).map((d: any) => ({
                        ...
                        fill:
                          chartConfig[
                            d.name.toLowerCase() as keyof typeof chartConfig
                          ]?.color || "var(--muted)",
                      }))}
                      dataKey="value"
                      nameKey="name"
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      <CardDescription className="text-xs font-medium">
                        Automated AI synthesis of scans in{" "}
                    ...
                    <div className="grid md:grid-cols-12 gap-8 items-start">
                      <div className="md:col-span-8 space-y-6">
                        <div className="grid gap-3">
                          {latestAnalysis.headlines
                            .slice(0, 2)
                            .map((headline: string, i: number) => (
                              <div
                                key={i}
                                className="flex gap-4 items-start p-4 rounded-2xl bg-background border border-border/50 group hover:border-primary/30 transition-colors"
                              >
                        ...
                        <div className="p-5 rounded-2xl border border-border/50 bg-background/50 space-y-4">
                          <div className="flex justify-between items-end border-b border-border/50 pb-3">
                            ...
                            <span className="text-sm font-bold font-brand">
                              {new Date(
                                latestAnalysis.lastProcessedAt,
                          ...
                          <div className="flex justify-between items-end border-b border-border/50 pb-3">
                            ...
                            <span className="text-sm font-bold font-brand">
                              {latestAnalysis.lastScanCount} records
                            </span>
                          </div>
                          <div className="flex justify-between items-end">
                            ...
                            <span className="text-sm font-bold font-brand text-primary">
                              {(
                                latestAnalysis.stats as any
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-center space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground max-w-[300px]">
                          Run your first area scan to generate predictive
                          intelligence for this jurisdiction.
                        </p>
                      </div>
                    </div>
                  )}
          ...
          <div className="pt-20 flex flex-col items-center justify-center text-center space-y-3 opacity-50">
            ...
            <p className="text-[9px] text-muted-foreground font-medium max-w-sm">
              Proprietary Intelligence Dashboard. Data subject to AI confidence
              thresholds and regional scan density.
            </p>
          </div>
        </div>
      </div>
