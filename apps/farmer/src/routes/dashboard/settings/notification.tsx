                ...
                <div className="lg:w-1/3 space-y-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Manage your alerts and staying updated with the latest from Cropia.
                        </p>
                    </div>
                    ...
                    <div className="space-y-6">
                        {isLoading ? (
                            <div className="flex flex-col items-center justify-center py-12 space-y-4">
                                ...
                                <p className="text-sm text-muted-foreground animate-pulse">Syncing Alerts...</p>
                            </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0 space-y-1">
                                                    <div className="flex items-start justify-between gap-2">
                                                        ...
                                                        {notification.from && (
                                                            <Badge variant="outline" className="text-[10px] h-5 px-1.5 uppercase tracking-wider font-medium text-muted-foreground bg-muted/50 border-border/50">
                                                    ...
                                                    <p className={cn(
                                                        ...
                                                        !notification.seen ? "text-foreground/80" : "text-muted-foreground"
                                                    )}>
                                                        {notification.body}
                                                    </p>
                                                </div>
